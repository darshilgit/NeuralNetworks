...
class LeftFrame:
	...
	def __init__(self, root, master, debug_print_flag=False):
		...
		self.activation_function_dropdown = tk.OptionMenu(self.controls_frame, self.activation_function_variable,
		                                                  "Sigmoid", "Linear", "Hyperbolic Tangent", "Positive Linear", command=lambda
	...
	def display_activation_function(self):
		...
		activation = Parikh_01_02.calculate_activation_function(self.input_weight, self.bias, input_values,
...
main_window.title('Assignment_01 --  Parikh')
